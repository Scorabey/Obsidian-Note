...
| 🎯 Статус              | Завершено  |
| 📅 Початок             | 2026-05-19 |
| 🔁 Наступне повторення | 2026-05-19 |
| ⏱️ Годин витрачено     | 0          |
...
| ------------------------ | ---- | ------- | --------- |
| 1000 Basic English Words | 1000 | 425     | Завершено |

### 📦 Нові слова цього тижня

| Слово    | Транскрипція | Переклад |
| -------- | ------------ | -------- |
| Waiter   | [ˈweɪ.tər]   | Офіціант |
| Customer | [ˈkʌstəmər]  | Клієнт   |
| Eraser   | [ɪˈreɪ.zər]  | Ластик   |
| Rug      | [rʌɡ]        | Ковер    |
| Vase     | [vɑːz]       | Ваза     |
| Oven     | [ˈʌv.ən]     | Піч      |
...
- **Поточний streak:** 9 днів
- **Максимальний streak:** 9 днів
- **Всього вивчено слів:** 425
- **Слів повторено сьогодні:** 37
...
| ---------- | -------------------------------------- | ------ | ------ |
| 19.05.2026 | Prepositions of time: 'at', 'in', 'on' | A1-A2  |        |
...
```
Правило: Використовуєм з годиником і часом прийому їжі
Приклади:
	I get up at 6.30 a.m. and go for a run.
	She doesn't like to leave the office at lunchtime.

Правило: Також використовуєм з фазами дня
Приклади:
	At the weekend, I can spend the days how I like.

Правило: Використовується з святами які тривають кілька днів
Приклади:
...
```
Правило: Використовуєм для доби та порами часу такими як місяці та пори року
Приклади:
...
| Правила                     | Приклади                                                                |
| --------------------------- | ----------------------------------------------------------------------- |
| Пори дня                    | In the morning \| afternoon \| evening                                  |
| Місяці                      | In January \| February                                                  |
| Сезони                      | In (the) spring \| summer \| autumn \| winter                           |
| Роки, століття, десятиліття | In 2016 \| In the 21st century \| In the 80s                            |
| Інші часові фрази           | In the past \| In the futury \| in the last few years/months/weeks/days |

---
#### On

```
Правило: Використовуэм з днями та датами
Приклади:
	On Fridays
	On 13 february
```
...
| ----------- | ----- | ------- | -------- | ----- | --------- |
| Castelvania | Anime | English | English  | 6     | Завершено |

### 📺 Журнал перегляду

| Дата       | Назва       | Епізод | Нові слова | Нові фрази | Час (хв) |
| ---------- | ----------- | ------ | ---------- | ---------- | -------- |
| 19.05.2026 | Castelvania | 6      |            |            | 31       |
...
_Шаблон створено: 2026-05-19 | Оновлено: 2026-05-19_