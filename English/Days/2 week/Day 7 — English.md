...
|🎯 Статус|В процесі|
|📅 Початок|2026-05-20|
|🔁 Наступне повторення|2026-05-20|
|⏱️ Годин витрачено|0|
...
| ------------------------ | ---- | ------- | --------- |
| 1000 Basic English Words | 1000 | 430     | В процесі |

### 📦 Нові слова цього тижня

| Слово | Транскрипція | Переклад | Приклад речення           |
| ----- | ------------ | -------- | ------------------------- |
| Begin | [bɪˈɡɪn]     | Починати | You begin play are tennis |

### 💪 Streak та статистика

- **Поточний streak:** 10 днів
- **Максимальний streak:** 10 днів
- **Всього вивчено слів:** 430
- **Слів повторено сьогодні:** 38
...
| ---------- | -------------- | ------ | ------ |
| 20.05.2026 | Present simple | A1-A2  | 4      |
...
```
Правило: Факти та загальні поняття
Приклади:
	The sun rises in the east

Правило: Звички та регулярні дії
Приклади:
	I drink coffe every morning

Правило: Розклади та програми
Приклади:
	I start my work at 8 AM

Правило: Стани та почуття
Приклади:
	He love play basketball
```

==Як утворювати==

| Тип речення     | Я/Ти/Ми/Вони | Він/Вона/Воно    |
| --------------- | ------------ | ---------------- |
| ✅Стверджувальне | I play       | He play          |
| ❌Заперечне      | I don`t play | He doesnt`t play |
| ❓Питальне       | Do you play? | Does he play?    |
...
_Шаблон створено: 2026-05-20 | Оновлено: 2026-05-20_