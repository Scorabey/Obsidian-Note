...
| 🎯 Статус              | Завершено  |
| 📅 Початок             | 2026-06-11 |
| 🔁 Наступне повторення | 2026-06-11 |
| ⏱️ Годин витрачено     | 1          |
...
| ------- | ------------ | ----------------- | ------------------------------------------------------------ |
| Block   | [ blɑ́k]     | Квартал/Блокувати | There are many houses on each **block**                      |
| Borrov  | [ bɑ́rou]    | Позичати          | Thank you for letting me **borrow** your math book this week |
| Bowl    | [ bóul]      | Чаша              | I had a big **bowl** of soup for lunch                       |
| Confuse | [ kənfjúːz]  | Збити з пантелику | Math **confuses** Scott                                      |
| Seem    | [ síːm]      | Здається          | They **seem** to be enjoying the funny movie tonight         |

### 💪 Streak та статистика

- **Поточний streak:** 1 днів
- **Максимальний streak:** 1 днів
- **Слів повторено сьогодні:** 50
...
| ---------- | -------------------------------- | ------ | ------ |
| 2026-06-11 | Nouns: countable and uncountable | A2     | 4      |
...
| ------- | ----- | ------- | -------- | ----- | --------- |
| Youtube | Movie | English | English  | 1     | Завершено |

### 📺 Журнал перегляду

| Дата       | Назва   | Епізод | Нові слова | Нові фрази | Час (хв) |
| ---------- | ------- | ------ | ---------- | ---------- | -------- |
| 2026-06-11 | Youtube | 1      |            |            | 30       |
...
_Шаблон створено: 2026-06-11 | Оновлено: 2026-06-11_