...
| 🎯 Статус              | В процесі  |
| 📅 Початок             | 2026-05-06 |
| 🔁 Наступне повторення | 2026-05-06 |
| ⏱️ Годин витрачено     | 1          |
...
| ------------------------ | ---- | ------- | ---------- |
| 1000 Basic English Words | 1000 | 341     | В процессі |

### 📦 Нові слова цього тижня

| Слово    | Транскрипція  | Переклад   | Приклад речення                             |
| -------- | ------------- | ---------- | ------------------------------------------- |
| Into     | ['inta]       | В середину | They climbing into the truck and drove away |
| Armchair | ['a:mtjea(r)] | Крісло     | They sat on armchair                        |

### 💪 Streak та статистика

- **Поточний streak:** 2 днів
- **Максимальний streak:** 2 днів
- **Всього вивчено слів:** 358
...
| ---------- | ------------------------------------- | ------ | ------ |
| 06.05.2026 | Adjectives ending in '-ed' and '-ing' | A1-A2  | 6/10   |
...
```
Правило: Описує людину, яка відчуває
Приклади:
	I'm bored
	She's shocked
```
...
```
Правило: Описує річ або ситуацію, що викликає емоцію
Приклади:
...
| ----------- | --- | ------- | -------- | ----- | -------- |
| Castelvania | -   | English | English  | 3.6   | Виконано |
...
| ---------- | ----------- | ------ | ---------- | ---------- | -------- |
| 06.05.2026 | Castelvania | 3.6    | Judge      | -          | 25       |
...
#### **British Council — що вивчав(ла):** Adjectives ending in '-ed' and '-ing'

#### **Медіа — що дивився(лась):** Castelvania S3 E6
...
_Шаблон створено: 2026-05-06 | Оновлено: 2026-05-06_