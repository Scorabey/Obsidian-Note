...
|🎯 Статус|В процесі|
|📅 Початок|2026-05-08|
|🔁 Наступне повторення|2026-05-08|
|⏱️ Годин витрачено|0|
...
| ------------------------ | ---- | ------- | ---------- |
| 1000 Basic English Words | 1000 | 364     | В процессі |

### 📦 Нові слова цього тижня

| Слово | Транскрипція | Переклад | Приклад речення                                   |
| ----- | ------------ | -------- | ------------------------------------------------- |
| Suit  | [su:t]       | Костюм   | All the businessmen were wearing pinstripe suites |
| Deer  | [dia(r)]     | Олень    | Big and strong deer                               |
| chest | [tjest]      | Грудь    |                                                   |
...
| ---------- | ----------------------------- | ------ | ------ |
| 08.05.2026 | Articles: 'a', 'an', 'the'    | A1-A2  | 4      |
| 08.05.2026 | Articles: 'the' or no article | A1-A2  | 4      |
...
```
Правило: Ми зачасту не використовуєм артиклі коли говоримо про якесь місце
Приклади:
	go to bed / be in bed
	go to work / be at work / start work / finish work
	go home / be at home / get home / stay at home
Правило: Проте говоримо з артиклем коли хтось відвідує місце як не як студент - коли відвідує університет, чи вчитель - школу
Приклади: 
...
```
Правило: Не використовуєм артиклі коли говоримо про країни, озера, гору, селща і тощо.
Приклади:
	Africa, Asia, Europe
...
Правило: Використовуєм арктиклі якщо в імені країни є United, або якщо назва університета починається с U
```
...
_Шаблон створено: 2026-05-08 | Оновлено: 2026-05-08_