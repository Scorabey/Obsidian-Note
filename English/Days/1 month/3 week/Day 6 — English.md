...
| 🎯 Статус              | Завершено  |
| 📅 Початок             | 2026-05-28 |
| 🔁 Наступне повторення | 2026-05-28 |
| ⏱️ Годин витрачено     | 1          |
...
- **Поточний streak:** 16 днів
- **Максимальний streak:** 16 днів
...
| ---------- | -------------------------------------- | ------ | ------ |
| 28.05.2026 | Verbs followed by '-ing' or infinitive | A1-A2  | 4      |

### 📝 Граматичні правила

#### Verbs followed by the -_ing_ form

```
Правило: Дієслова почуттів та вподобань (enjoy, like, hate, mind, avoid, miss) → -ing
Приклади:
	I enjoy swimming
	I mind parent
```

#### Verbs followed by _to_ + infinitive form

```
Правило: Дієслова бажання та рішення (want, decide, plan, hope, offer, refuse) → to + інфінітив
Приклади:
	I want to home
	i planing to map
```
...
| ----------------------------------------------------------- | ----- | ------- | -------- | ----- | --------- |
| [Youtube](https://youtu.be/Caxv8tLATnc?si=55lzL1TsxwdwCc3S) | Movie | English | English  | 1     | Завершено |

### 📺 Журнал перегляду

| Дата       | Назва                                                       | Епізод | Нові слова | Нові фрази | Час (хв) |
| ---------- | ----------------------------------------------------------- | ------ | ---------- | ---------- | -------- |
| 28.05.2026 | [Youtube](https://youtu.be/Caxv8tLATnc?si=55lzL1TsxwdwCc3S) | 1      |            |            | 19       |
...
[Youtube](https://youtu.be/Caxv8tLATnc?si=55lzL1TsxwdwCc3S)
#### **Час (год):**
1
...
_Шаблон створено: 2026-05-28 | Оновлено: 2026-05-28_