...
| 🎯 Статус              | Завершено  |
| 📅 Початок             | 2026-05-21 |
| 🔁 Наступне повторення | 2026-05-21 |
| ⏱️ Годин витрачено     | 1          |
...
| ------------------------ | ---- | ------- | --------- |
| 1000 Basic English Words | 1000 | 436     | В процесі |
...
- **Поточний streak:** 11 днів
- **Максимальний streak:** 11 днів
- **Всього вивчено слів:** 436
...
| ---------- | -------------------------- | ------ | ------ |
| 21.05.2026 | Present simple: 'have got' | A1-A2  | 4      |
...
```
Правило: Ми використовуэмо I/you/we/they + have got or he/she/it + has got, щоб сказати про те що ми маэмо
Приклади:
	They have got a big garden. = They have a big garden.
	She has got a good job. = She has a good job.

Правило: Ми також використовуємо have/has got, щоб сказати про зовнішній вигляд, дієслово часто скорочується при розмові
Приклади: 
...
Правило: Ми також використовуємо have/has got для запланованих подій
Приклади:
...
_Шаблон створено: 2026-05-21 | Оновлено: 2026-05-21_