...
| 🎯 Статус              | Завершено  |
| 📅 Початок             | 2026-05-16 |
| 🔁 Наступне повторення | 2026-05-16 |
| ⏱️ Годин витрачено     | 1          |
...
| ------------------------ | ---- | ------- | --------- |
| 1000 Basic English Words | 1000 | 407     | В процесі |

### 📦 Нові слова цього тижня

| Слово | Транскрипція | Переклад | Приклад речення           |
| ----- | ------------ | -------- | ------------------------- |
| Wall  | [wl]         | Стіна    | I destroy wall im my room |
| Neck  | [nek]        | Шия      |                           |
| Bake  | [beɪk]       | Запікати |                           |

### 💪 Streak та статистика

- **Поточний streak:** 7 днів
- **Максимальний streak:** 7 днів
- **Всього вивчено слів:** 407
...
| ----------- | ----- | ------- | -------- | ----- | --------- |
| Castelvania | Anime | English | English  | 4     | Завершено |

### 📺 Журнал перегляду

| Дата        | Назва       | Епізод | Нові слова | Нові фрази | Час (хв) |
| ----------- | ----------- | ------ | ---------- | ---------- | -------- |
| 16.05..2026 | Castelvania | 4      |            |            | 28       |
...
_Шаблон створено: 2026-05-16 | Оновлено: 2026-05-16_