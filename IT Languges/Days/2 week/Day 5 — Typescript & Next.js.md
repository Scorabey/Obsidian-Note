...
- [x] Typescript modules
	- [x] Namespaces
- [x]  Next.js
	- [x] [[Next.js термінологія муршрутезації]]
	- [x] [[Next.js Рендеринг сторінок]]
---

## 📚 Ресурси для навчання

### Документація
- [Advenced types](https://www.typescriptlang.org/docs/handbook/advanced-types.html)
- [Template literal type](https://www.typescriptlang.org/docs/handbook/2/template-literal-types.html)
### Корисні сайти
- [Recursive types](https://www.freecodecamp.org/news/recursive-types-in-typescript-a-brief-exploration/)
...
type Uppercase = Uppercase<Greeting>
type Lowercase = Lowercase<Greeting>
type Capitalize = Capitalize<Greeting>
type Uncapitalize = Uncapitalize<Greeting>
...
#### **Нотатки:**
> Uppercase — Перетворює весь текст в верхній регістр
> Lowercase — Перетворює весь текст в нижній регістр
> Capitalize — Перевторює першу букву тексту у верхній регістр
> Uncapitalize — Перевторює першу букву тексту у нижній регістр
...
- Namespaces
- Next.js
- [[Next.js термінологія муршрутезації]]
- [[Next.js Рендеринг сторінок]]
### **Час (год):** 
2 години
...
*Шаблон створено: 2026-05-18 | Оновлено: 2026-05-18
