...
## 🗺️ Roadmap навчання
### Фаза 1: Середній рівень (Intermediate)
- [x] Instaceof
- [x] Typeof
- [x] Equality
- [x] Truthiness
...
### Документація
- [Narrowing](https://www.typescriptlang.org/docs/handbook/2/narrowing.html#equality-narrowing)
---
...
// Typeof
const dog = { name: 'Rex' }
console.log(typeof dog == "object") // true 
```
...
*Шаблон створено: 2026-05-08 | Оновлено: 2026-05-08
