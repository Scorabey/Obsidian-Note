...
### Документація
- [Generic Constaints](https://www.typescriptlang.org/docs/handbook/2/generics.html#generic-constraints)
...
### Відео курси
- [Decorators](https://youtu.be/HU8W-oEi-EA?si=U5B1yDa7tKkKzSxn)

### Корисні сайти
- [Custom Document and App](https://claude.ai/chat/6c7ebb68-970d-4522-bf3c-8497ad3e443f)
...
// Generic types
function iidentity<Type>(first: Type, seccond: Type): Type {
...
  return <h1>Post: {slug}<h1>; // Post: any-name 
}
...
#### **Нотатки:**
> Generic constaints — обмежує типи які можна використати
> Custom App — подібна система до layout, зараз вже непотрібна, тому що layout її замінив
...
*Шаблон створено: 2026-05-12 | Оновлено: 2026-05-12
