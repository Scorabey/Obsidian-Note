...
### Документація
- [Typescript interfaces](https://www.typescriptlang.org/docs/handbook/interfaces.html#readonly-vs-const)
- [Interfaces declaration](https://claude.ai/chat/3bdb5694-229e-4ba4-a41c-f7a4ef21fe69)
### Відео курси
- [Бази данних](https://youtu.be/8L51FUsjMxA?si=34oiy2-5KXTIfUOh)
### Корисні сайти
- [Interface VS Type](https://claude.ai/chat/e52e58cc-e74f-430e-8da0-f7b3a101cd2d)
...
#### **Нотатки:**
> Interface VS type: 
> 	Type: псевдонім для будь якого типу
> 	Interface: описує форму об'екта
> 	
> ==Інтерфейси можуть розширювати кілька інтерфейсів==
...
*Шаблон створено: 2026-05-10 | Оновлено: 2026-05-10
