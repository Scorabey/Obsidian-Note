...
### Пройдені теми: 
- [x] Next.js
	- [x] Layouts and templates
	- [x] Loading and streaming
---

## 📚 Ресурси для навчання

### Документація
- [Layouts and templates](https://nextjs.org/docs/pages/building-your-application/routing/pages-and-layouts)
- [Loading and streaming](https://nextjs.org/docs/14/app/building-your-application/routing/loading-ui-and-streaming)
...
*Шаблон створено: 2026-05-19 | Оновлено: 2026-05-19
