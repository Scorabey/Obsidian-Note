...
### Документація
- [Image](https://nextjs.org/docs/app/getting-started/images)
- [Video](https://nextjs.org/docs/app/guides/videos)
- [Font](https://nextjs.org/docs/app/getting-started/fonts)
...
  return (
    <>
    <video width="1080" height="1024" controls preload="none">
      <source src="/video.mp4" type="video/mp4" />
      Your browser does not support the video tag.
    </video>
    <iframe src="https://youtu.be/9mpa45XOWgc?si=rITU9qb688iNq2Wq" allowFullScreen/>
    </>
  );
}
...
*Шаблон створено: 2026-05-28 | Оновлено: 2026-05-28
