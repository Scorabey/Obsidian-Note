...
### Документація
- [Union and intersection types](https://www.typescriptlang.org/docs/handbook/unions-and-intersections.html)
---
...
type AtworksRespone = ArtworksData & ErrorHandling;
...
// typeof operator
let userInputValue = "Hello World!"
let value: typeof userInputValue // value: string
```

#### **Нотатки:**
> Union type — поєднує в собі декілька типів, змінна з union типом може бути одним із кількох типів
> Intersection type — Поєднує декілька типів в собі
...
        case "success":
            return `Downloading succes! Title: ${state.response.title}, summary: ${state.response.summary}`
    }
}
```
...
*Шаблон створено: 2026-05-07 | Оновлено: 2026-05-07
